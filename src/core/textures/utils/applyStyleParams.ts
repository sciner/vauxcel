...
import type { TextureStyle } from '../TextureStyle.js';
...
)
{
    ...
    const wrapModeS = wrapModeToGlAddress[forceClamp ? 'clamp-to-edge' : style.wrapModeU];
    const wrapModeT = wrapModeToGlAddress[forceClamp ? 'clamp-to-edge' : style.wrapModeV];
    const wrapModeR = wrapModeToGlAddress[forceClamp ? 'clamp-to-edge' : style.wrapModeW];
