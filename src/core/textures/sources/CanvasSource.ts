import { ICanvas } from '@pixi/settings/index.js';
import { ExtensionType } from '../../../extensions.js';
import { TextureSource } from './TextureSource';

import type { ExtensionMetadata } from '../../../extensions.js';
...
export class CanvasSource extends TextureSource<ICanvas>
{
    ...
    constructor(options: CanvasSourceOptions)
    {
        if (!options.resource)
        {
            options.resource = document.createElement('canvas');
        }
    ...
    public static test(resource: any): resource is HTMLCanvasElement
    {
