...
import { clamp, clampHue, isPresent, round } from './helpers.js';
import { hsvaToRgba, rgbaToHsva } from './hsv.js';
import { ColorInputObject, HslaColor, HsvaColor, RgbaColor } from './types.js';
...
export const parseHsla = ({ h, s, l, a = 1 }: ColorInputObject): RgbaColor | null =>
{
