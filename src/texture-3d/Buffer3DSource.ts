import { TextureSource, TextureSourceOptions, TypedArray } from '@pixi/core/index.js';
 ...
 * @memberof PIXI
 */
export interface IBuffer3DResourceOptions extends TextureSourceOptions<TypedArray>
{
 ...
 * @memberof PIXI
 */
export class Buffer3DSource extends TextureSource<TypedArray>
{
