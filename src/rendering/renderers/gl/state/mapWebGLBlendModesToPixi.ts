...
export function mapWebGLBlendModesToPixi(gl: GlRenderingContext): Record<BLEND_MODES, number[]>
{
    ...
    blendMap['normal-hack'] = [gl.ONE, gl.ONE_MINUS_SRC_ALPHA, gl.ONE, gl.ONE, gl.FUNC_ADD, gl.MAX];
    blendMap['normal-npm-hack'] = [gl.SRC_ALPHA, gl.ONE_MINUS_SRC_ALPHA, gl.ONE, gl.ONE, gl.FUNC_ADD, gl.MAX];
