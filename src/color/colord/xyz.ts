...
import { ALPHA_PRECISION } from './constants.js';
import { clamp, isPresent, round } from './helpers.js';
import { clampRgba, linearizeRgbChannel, unlinearizeRgbChannel } from './rgb.js';
import { ColorInputObject, RgbaColor, XyzaColor, XyzColor } from './types.js';
...
export const parseXyza = ({ x, y, z, a = 1 }: ColorInputObject): RgbaColor | null =>
{
