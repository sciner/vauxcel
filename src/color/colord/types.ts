...
export type ColorInputObject = Record<string, unknown>;
...
export type ColorInput = string | ColorInputObject;

export type ColorParseResult = [RgbaColor, ColorFormat];

export type ColorParseFunction<I extends ColorInput> = (input: I) => RgbaColor | null;

export type ColorParser<I extends ColorInput> = [ColorParseFunction<I>, ColorFormat];

export type ColorParsers = {
    string: Array<ColorParser<string>>;
    object: Array<ColorParser<ColorInputObject>>;
};
